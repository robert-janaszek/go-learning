...
// Często kanał służy jedynie do wysłania sygnału ("coś się stało"),
// a nie przesyłania danych. W Go używa się do tego typu chan struct{},
// ponieważ struct{} zajmuje 0 bajtów w pamięci!
// Stwórz kanał done := make(chan struct{}) i użyj go do powiadomienia main()
// o zakończeniu tła.
